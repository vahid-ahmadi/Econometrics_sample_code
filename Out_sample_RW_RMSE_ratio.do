...
**
gen stat=.
replace stat = (model_big_re_sq /model_small_re_sq)^0.5
...
sort currency date
keep currency stat
collapse (mean) stat ,by (currency)
gen diff="`diff'"
gen macro_var="`z'"
save "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//T2i_`x'_d`diff'_`z'.dta",replace
restore
}
}
}
...
foreach diff in 1 3 12 24 {
foreach x in SA{
use "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//T2i_`x'_d`diff'_US_term_1.dta"
foreach z in TED US_term_2 ln_vix_avg epu_adj all_DB_inflow_IMF_GDP global_convenience_yield {
append using "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//T2i_`x'_d`diff'_`z'.dta"
rm "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//T2i_`x'_d`diff'_`z'.dta"
}
save "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//T2i_`x'_d`diff'_all.dta",replace
}
}

clear all 
use "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//T2i_SA_d1_all.dta"
foreach diff in 3 12 24 {
append using "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//T2i_SA_d`diff'_all.dta"
}
drop currency
...
rename diff Horizon
rename stat EM_Realized
save "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//EM_Realized_RMSE.dta",replace
...
rename  macro_var Independent_variables
rename diff Horizon
rename stat AE_Realized
save "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//AE_Realized_RMSE.dta",replace
...
rename  macro_var Independent_variables
rename diff Horizon
rename stat EM_Expected
save "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//EM_Expected_RMSE.dta",replace
...
rename  macro_var Independent_variables
rename diff Horizon
rename stat AE_Expected
save "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//AE_Expected_RMSE.dta",replace
...
clear all 
use "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//AE_Expected_RMSE.dta"
merge 1:1 Horizon Independent_variables using "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//EM_Expected_RMSE.dta", nogen
merge 1:1 Horizon Independent_variables using "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//AE_Realized_RMSE.dta", nogen
merge 1:1 Horizon Independent_variables using "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//EM_Realized_RMSE.dta", nogen

export delimited using "$path/UIP/vahid/empirics_alvaro/codes/Random_walk//RW_outsample_RMSE.csv", replace
